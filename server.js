...
const dashboardData = {
  "dashboard": {
    ...
    "monthlyTarget": {
      ...
      "message": "Our achievement increased by NPR 200,000 Let's reach 100% next month",
      "target": 600000,
      "revenue": 510000,
      "totalGoal": 3400000
    },
    ...
    "recentActivity": [
      ...
      {
        "timestamp": "1:15 PM",
        "message": "Madhan Shrestha's order #10245 status changed from 'Pending' to 'Processing'."
      },
      {
        "timestamp": "11:30 AM",
        "message": "Saurav Ghimire left a 5-star review for 'Bose QuietComfort Ultra'."
      },
      {
        "timestamp": "10:20 AM",
...
app.get('/api/dashboard/revenue-analytics', (req, res) => {
...
app.get('/api/dashboard/active-users', (req, res) => {
  res.json(dashboardData.dashboard.activeUser);
});

app.get('/api/dashboard/conversion-rate', (req, res) => {
  res.json(dashboardData.dashboard.conversionRate);
});

app.get('/api/dashboard/traffic-sources', (req, res) => {
...
app.listen(PORT, () => {
  ...
  console.log(`  GET /api/dashboard/revenue-analytics - Revenue data`);
  console.log(`  GET /api/dashboard/recent-orders - Recent orders`);
  console.log(`  GET /api/dashboard/recent-activity - Recent activity`);
  console.log(`  GET /api/dashboard/top-categories - Top categories`);
  console.log(`  GET /api/dashboard/active-users - Active user data`);
  console.log(`  GET /api/dashboard/conversion-rate - Conversion metrics`);
  console.log(`  GET /api/dashboard/traffic-sources - Traffic sources`);
});
